...
Plots helper graphs for explaining the geometry of linear classifiers, including
the decision surface, the projection of a point onto the weight vector, and the
decomposition of a point into components parallel and perpendicular to the weight vector.
"""
